                    ...
                    <table className='table table-bordered'>
                            ...
                            <tbody>
                                ...
                                <td>
                                    ...
                                    <Link  to={'/edit-chapter/'+chapter.id} > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash3-fill ml-4" viewBox="0 0 16 16">
